export const translations = {
  en: {
    ...
    competencies: {
      ...
      items: [
        ...
        { num: "03", title: "More", desc: "These days I don’t just do design and research – I’m also learning to build websites with AI tools (this site is one of them)." },
        { num: "04", title: "In my free time", desc: "I make music, travel, and learn to sew clothes." }
      ]
    },
    contact: {
    ...
    experience: {
      ...
      items: [
        ...
        { year: "Dec 2021 – Feb 2022", company: "Росэлторг (группа ВТБ)", role: "Product Designer" },
  ...
  ru: {
    ...
    competencies: {
      ...
      items: [
        { num: "01", title: "Образование", desc: "Высшее, СПбГУ.\nФакультет: Высшая школа журналистики и массовых коммуникаций. Кафедра: Медиадизайн." },
    ...
    contact: {
      title: "Пишите!",
      description: "Открыта для фриланс-проектов и постоянного сотрудничества.",
    ...
    experience: {
      ...
      items: [
        ...
        { year: "декабрь 2021 – февраль 2022", company: "Росэлторг (группа ВТБ)", role: "Product Designer" },
...
Мы также реализовали вьетнамскую версию и запустили на вьетнамский рынок (и для нее я отдельно нарисовала дизайн)).`,
    ...
    },
    {
      ...
      role: "PRODUCT DESIGNER",
      title: "СКИЗИ",
      description: "СКИЗИ – это система, которая помогает учитывать и контролировать использование «зелёных» инструментов и прав. В ней пользователь может зафиксировать, передать и «погасить» зелёные права, а ещё хранит всю информацию по ним и выдаёт её по запросу."
    },
    {
      id: 4,
      year: "2025",
