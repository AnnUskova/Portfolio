      ...
      <section className="pt-40 pb-24 lg:pt-48 lg:pb-32 relative">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex items-start justify-between">
          <div className="max-w-4xl">
            ...
            >
              <h1 className={`font-medium tracking-tight text-balance whitespace-pre-line ${language === "ru" ? "text-2xl md:text-3xl lg:text-[40px]" : "text-4xl md:text-5xl lg:text-[52px]"}`} style={{ lineHeight: '115%' }} data-testid="text-hero-title">
                {t.hero.title}
              </h1>
            </motion.div>
