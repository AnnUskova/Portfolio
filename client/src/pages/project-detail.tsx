                ...
                <section>
                  ...
                  <div className="space-y-12 text-[18px] text-gray-600 leading-relaxed">
                    ...
                    <div className="space-y-4">
                      ...
                      <p>За месяц я собрала дизайн продукта, который объясняет свои решения и механики – чтобы можно было действовать уверенно, даже если ты не читаешь документацию на ночь.

                      * За 1 месяц: дизайн + координация фронта до состояния “готово к запуску”
                      * Закрыты ключевые флоу: Swap / Pools / Token Sale / Lock-Voting
                      * Продуманы edge cases и транзакционные состояния, которые критичны для доверия в DeFi
                      * Добавлены решения, снижающие отток и фрикшн: Faucet, видеогайды, подсказки в multi-step флоу



                      радует функциональностью и не путает навороченными механиками. Да, под капотом они действительно навороченные, но мы видим
                       Чистый и понятный интерфейс и 
                      по-человечески объясняет, что происходит 
                      чтобы можно было действовать уверенно, даже если ты не читаешь документацию на ночь.
                       собрала дизайн продукта, подружив его с реальностью новой сети и довели дизайн до фронта. Я закрыла ключевые флоу – swap, pools, token sale и lock/voting — и отдельно продумала все места, где люди обычно спотыкаются: газ, апрувы, статусы транзакций и ошибки. Для новичков встроили faucet и подсказки, для опытных — прозрачный route и техничные детали вроде адресов пулов.</p>
                      <p className="italic">
